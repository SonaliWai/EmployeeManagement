<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomePage.aspx.cs" Inherits="EmployeeManagement.Models.Pages.HomePage" %>
...
<body>
  ...
  <a class="navbar-brand" href="#"><img src="https://media-exp1.licdn.com/dms/image/C4E0BAQE_SFGM1PgQQA/company-logo_200_200/0/1519889670567?e=2147483647&v=beta&t=a7t0VCUvkgkiicBZVFWj7be8pApofE4mjjuHSmaZgbg" style="height:100px;"/></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="container-fluid display-table">
        <div class="row display-table-row">
            <div class="col-md-2 col-sm-1 text-danger display-table-cell v-align box" id="navigation">
                <div class="logo">
                    Dashbord
                </div>
                <div class="navi">
                    <ul>
                        <li class="active"><a href="#"><i class="fa fa-home" aria-hidden="true"></i><span class="hidden-xs hidden-sm">All Emp</span></a></li>
